...
//		logger.info("Entrato ...");
		try (AnnotationConfigApplicationContext ctx = new AnnotationConfigApplicationContext(DataServiceConfig.class)) {
			...
			Person p1 = personDao.create("test@hotmail.it", "passw",
					"Laurea in economia e gestione aziendale conseguito il 10 febbraio 2004 presso l�Universit� di Bologna", "/resources/img/logo2.jpg",
			...
			Person p2 = personDao.create("giangis@hotmail.it", "passw",
					"Diploma di Laurea in economia e gestione aziendale conseguito il 10 febbraio 2004 presso l�Universit� di Bologna", "/resources/img/logo3.jpg",
					"Marco", "Abbate", LocalDate.of(1990, 11, 25), "320000255", "Informatica, Ristorazione");
