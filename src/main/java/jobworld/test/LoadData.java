...
//		logger.info("Entrato ...");
		try (AnnotationConfigApplicationContext ctx = new AnnotationConfigApplicationContext(TestConfig.class)) {
			...
			try (Session session = sf.openSession()) {
				...
				// parte cifratura, va messo in questo ordine per far si che si popoli senza
				// errori
				...
				User u1 = userDao.create("saviofeng@gmail.it", userDao.encryptPassword("user1"), null,
						"/resources/img/users/galleria1.jpg");
				u1.addRole(r1);

				User u15 = userDao.create("admin@mail.it", userDao.encryptPassword("admin"), null, null);
				u15.addRole(r2);

				User u2 = userDao.create("tizioacaso@gmail.com", userDao.encryptPassword("user2"), null,
						"/resources/img/users/galleria2.jpg");
				u2.addRole(r1);

				User u3 = userDao.create("esselunga@gmail.com", userDao.encryptPassword("user3"), null,
						"/resources/img/companies/esselunga.jpg");
				u3.addRole(r3);

				User u4 = userDao.create("dark@gmail.it", userDao.encryptPassword("pass2word1"), null,
						"/resources/img/users/galleria3.jpg");
				u4.addRole(r1);

				User u5 = userDao.create("luca@gmail.it", userDao.encryptPassword("passwo42rd1"), null,
						"/resources/img/users/galleria4.jpg");
				u5.addRole(r1);

				User u6 = userDao.create("pippo@outlook.it", userDao.encryptPassword("pa41ssword1"), null,
						"/resources/img/users/galleria5.jpg");
				u6.addRole(r1);
				...
				User u8 = userDao.create("sony@gmail.it", userDao.encryptPassword("sony22"),
				...
				User u9 = userDao.create("samsung@email.it", userDao.encryptPassword("samsun1sg"),
				...
				User u10 = userDao.create("GiGroup@email.it", userDao.encryptPassword("sdadsa"),
						"GiGroup � un agenzia per il lavoro che offre varie possibilit� lavorative",
						"/resources/img/companies/gigroup.jpg");
				u10.addRole(r3);

				User u11 = userDao.create("BeElite@email.it", userDao.encryptPassword("sda312dasa"),
						"BeElite � una societ� di marketing che offre diverse possibilit� di crescita",
						"/resources/img/companies/beelite.png");
				u11.addRole(r3);

				User u12 = userDao.create("Workhere@email.it", userDao.encryptPassword("ukyera"),
						"Workhere � un azienda di searching work", "/resources/img/companies/workhere.png");
				u12.addRole(r3);

				// creazione delle persone
				Person p2 = createPerson("Loris", "de luigi", LocalDate.of(1992, 4, 14), "3388775899",
						"informatica, ingegneria", u2, personDao);

				Person p1 = createPerson("Savio", "Feng", LocalDate.of(1995, 8, 25), "3588975899",
						"informatica, ingegneria", u1, personDao);

				Person p3 = createPerson("Marco", "vitale", LocalDate.of(1997, 2, 6), "3387675899",
						"informatica, ingegneria", u4, personDao);

				Person p4 = createPerson("Luca", "Nervi", LocalDate.of(1987, 8, 11), "3333475899", "sala, alberghiero",
						u5, personDao);

				Person p5 = createPerson("Pippo", "Baudo", LocalDate.of(1985, 8, 9), "3388775899",
						"meccanica, professionale", u6, personDao);
...
//creazione dei curriculum da associare alla persona per fare i vari test		
				Curriculum c11 = createCurriculum(new Curriculum(p1, "Assistente amministrativo\r\n" +
						...
						"Capacit� di lavorare in gruppo maturata in molteplici situazioni in cui era indispensabile la",

						"scrittura creativa: corso presso l'Informagiovani del Comune di Bologna"), curriculumDao,
						personDao);
				...
				Curriculum c13 = createCurriculum(new Curriculum(p3, "Programmatore Java" +
						...
						"Capacit� di apprendere nuovi linguaggi in poco tempo, e di lavorare in team",
...
//joboffer Le prime offerte di lavoro sono state create da noi per essere testate, quelle successive sono prese da siti come Infojobs e simili.
				...
				JobOffer j1 = createJobOffer("Lombardia", "Mantova", "Mantova", "ADDETTO AL REPARTO GASTRONOMIA",
						...
						"determinato", Education.LICENZA_MEDIA, "1 anno", LocalDate.of(2020, 1, 13), c1, jobOfferDao,
						companyDao);
				...
				JobOffer j2 = createJobOffer("Lazio", "Roma", "Roma", "Commesso GameStop",
						...
						"Si richiedono le seguenti caratteristiche:" +
								...
								"Capacit� di sopportare lo stress" +
						...
						"determinato", Education.DIPLOMA_DI_MATURITA, "6 mesi", LocalDate.of(2020, 2, 29), c2,
						jobOfferDao, companyDao);
				...
				JobOffer j3 = createJobOffer("Campania", "Napoli", "Napoli", "Programmatore Java",
						...
						"determinato", Education.LAUREA_TRIENNALE, "3 anni", LocalDate.of(2020, 12, 1), c1, jobOfferDao,
						companyDao);
				...
				JobOffer j4 = createJobOffer("Puglia", "Bari", "Bari", "Assisente di volo",
						...
						"determinato", Education.LAUREA_SPECIALISTICA, "1 anno", LocalDate.of(2020, 6, 15), c3,
						jobOfferDao, companyDao);
				...
				JobOffer j5 = createJobOffer("Marche", "Ancona", "Jesi", "Programmatore Cad",
						...
						"Indeterminato", Education.LAUREA_SPECIALISTICA, "indeterminato", LocalDate.of(2020, 12, 25),
						c4, jobOfferDao, companyDao);

				JobOffer j6 = createJobOffer("Lombardia", "Milano", "Milano",
						"FIERA MILANO: PRIMA ESPERIENZA NEL MARKETING",

						"La piu grande societ� di comunicazione e Marketing del Mondo con origini australiane" +
								...
								"- Possibilit� di Viaggi Nazionali e Internazionali" +

								"Luogo di lavoro nei principali Eventi e fiere di Milano e Provincia",

						"Determinato", Education.SENZA_STUDI, "1 mese", LocalDate.of(2020, 2, 14), c4, jobOfferDao,
						companyDao);

				JobOffer j7 = createJobOffer("Lombardia", "Milano", "Milano",
						"VIAGGI, FORMAZIONE E MARKETING: PRIMA ESPERIENZA MILANO",
						...
						"Determinato", Education.SENZA_STUDI, "1 mese", LocalDate.of(2020, 1, 5), c7, jobOfferDao,
						companyDao);

				JobOffer j8 = createJobOffer("Piemonte", "Torino", "Brandizzo",
						"ASSISTENTE AMMINISTRAZIONE E GESTIONE IMMOBILI",
						...
						"Nata nel 1999 e oggi fra i primi 10 player del mercato, ETJCA Agenzia per il lavoro e' una societa' consolidata, affidabile e competente che, attraverso la sua rete di filiali presenti in tutta Italia, offre alle persone in cerca di lavoro la possibilita' di trovare un'occupazione in linea con il proprio profilo professionale, favorendo il contatto con diverse realta' imprenditoriali."
								...
								"Per importante realt� con sede a Brandizzo (TO), Etjca Spa Filiale di Asti ricerca" +

								"UN ASSISTENTE ADDETTO ALL'AMMINISTRAZIONE E ALLA GESTIONE DEGLI IMMOBILI" +

								"La risorsa sar� alle dirette dipendenze della Direzione." +

								"I candidati ideali hanno le seguenti caratteristiche:" +

								"- laurea (preferibilmente) in ambito economico;" +

								"- buona conoscenza della lingua inglese e della lingua francese (le propriet� sono in Italia e all'estero);"
								+

								"- disponibilit� ad eventuali trasferte;" +
								...
								"- ampia disponibilit� oraria;" +

								"- dinamismo, professionalit� e seriet�;" +
						...
						"Determinato", Education.LAUREA_TRIENNALE, "3 anni", LocalDate.of(2020, 1, 28), c7, jobOfferDao,
						companyDao);
				...
				JobOffer j9 = createJobOffer("Lombardia", "Lecco", "Lomagna", "OPERATORE ELETTRONICO",
						...
						"A giornata", Education.DIPLOMA_DI_MATURITA, "1 anno", LocalDate.of(2020, 5, 9), c7,
						jobOfferDao, companyDao);
				...
				JobOffer j10 = createJobOffer("Lombardia", "Monza", "Vimercate", "ADDETTO/A AMMINISTRAZIONE SERVICE",
						...
						"determinato", Education.DIPLOMA_DI_MATURITA, "1 anno", LocalDate.of(2020, 1, 15), c7,
						jobOfferDao, companyDao);

				JobOffer j11 = createJobOffer("Lombardia", "Milano", "Milano", "LAVORO IN EVENTI - gennaio 2020",

						"Be Elite srl , importante societ� di marketing e comunicazione, seleziona per ampliamento organico aziendale , 5 nuove risorse."
								+

								"Le figure selezionate svolgeranno attivit� di promoting gestiranno le campagne pubblicitarie per clienti di fama mondiale all'interno di eventi organizzati."
								+

								"I profili in linea con la ricerca dovranno possedere i seguenti requisiti :" +

								"-domicilio o residenza a milano citt� o provincia" +
								...
								"-Concrete possibilit� di crescita" +

								"-Ambiente di lavoro dinamico, stimolante e giovanile" +

								"Per accedere alle selezioni , inviare la propria candidatura , seguir� un primo contatto telefonico.",

						"a giornata", Education.DIPLOMA_DI_MATURITA, "3 mesi", LocalDate.of(2020, 3, 11), c6,
						jobOfferDao, companyDao);
				...
				JobOffer j12 = createJobOffer("Campania", "Salerno", "Baronissi", "Disegnatore meccanico",
						...
						"indeterminato", Education.DIPLOMA_DI_MATURITA, "indeterminato", LocalDate.of(2020, 6, 12), c5,
						jobOfferDao, companyDao);
				...
				JobOffer j13 = createJobOffer("Lombardia", "Milano", "Milano", "CHEF DE PARTIE - SECONDI PIATTI",
						...
						"determinato", Education.DIPLOMA_DI_MATURITA, "1 anno", LocalDate.of(2020, 10, 2), c5,
						jobOfferDao, companyDao);
				...
				JobOffer j14 = createJobOffer("Lombardia", "Milano", "Milano", "RUNNER - LUXURY RESTAURANT",
						...
						"determinato", Education.DIPLOMA_DI_MATURITA, "1 anno", LocalDate.of(2020, 3, 7), c5,
						jobOfferDao, companyDao);
				...
				JobOffer j15 = createJobOffer("Lombardia", "Monza", "Vimercate", "ADDETTI MENSA",
						...
						"a giornata", Education.DIPLOMA_DI_MATURITA, "3 mesi", LocalDate.of(2020, 4, 4), c5,
						jobOfferDao, companyDao);
				 ...
				 */
				// personDao.apply(p1, j1);; lancia un'eccezione perchè non ci si può candidare
				// due volte per la stessa offerta
				...
				/*
				 * //session.beginTransaction(); //p1=personDao.unapply(p1, j1);
				 * //session.getTransaction().commit(); //DELETE JOBOFFER
				 * deleteJobOffer(j1,session,jobOfferDao);
				 * 
				 * //DELETE COMPANY //deleteCompany(c1,session,companyDao,jobOfferDao);
				 * 
				 * //DELETE USER deleteUser(u4,session,userDao);
				 * 
				 * //DELETE PERSON deletePerson(p1,session,personDao);
				 * 
				 * //DELETE CURRICULUM deleteCurriculum(c12,session,personDao,curriculumDao);
				 * 
...
//		logger.info("Esco ...");
	...
	private static JobOffer createJobOffer(String region, String province, String town, String position,
			String description, String contractType, Education minEducationLevel, String minExperience,
			LocalDate expiringDate, Company company, JobOfferDao jobOfferDao, CompanyDao companyDao) {
	 ...
	 * @return person
	 */
	private static Person createPerson(String firstName, String secondName, LocalDate birthdate, String number,
			String interests, User user, PersonDao personDao) {
