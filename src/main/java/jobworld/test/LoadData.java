...
//		logger.info("Entrato ...");
		try (AnnotationConfigApplicationContext ctx = new AnnotationConfigApplicationContext(TestConfig.class)) {
			...
			User u7=userDao.create("gamestop@email.it", userDao.encryptPassword("gamestop1"), "GameStop Corporation, noto semplicemente come GameStop, � un'azienda statunitense con sede nella citt� di Grapevine. � il pi� grande rivenditore di videogiochi nuovi e usati nel mondo, ma si occupa anche della vendita di accessori per videogiochi, console ed altri apparecchi elettronic", 
			"/resources/img/companies/gamestop.png");
			u7.addRole(r3);
			
			User u8=userDao.create("sony@gmail.it",  userDao.encryptPassword("sony22"), "La Sony Corporation, � una multinazionale conglomerata giapponese fondata nel 1946 con sede a Minato, quartiere di Tokyo. Sony si concentra principalmente sull'elettronica di consumo, sui videogiochi, intrattenimento e servizi finanziari.", "/resources/img/companies/sony.png");
			u8.addRole(r3);
			...
			User u10=userDao.create("GiGroup@email.it", userDao.encryptPassword("sdadsa"), "GiGroup � un agenzia per il lavoro che offre varie possibilit� lavorative", "/resources/img/companies/gigroup.jpg");
			u10.addRole(r3);
			
			User u11=userDao.create("BeElite@email.it", userDao.encryptPassword("sda312dasa"), "BeElite � una societ� di marketing che offre diverse possibilit� di crescita", "/resources/img/companies/beelite.png");
			u11.addRole(r3);
			
			User u12=userDao.create("Workhere@email.it", userDao.encryptPassword("ukyera"), "Workhere � un azienda di searching work", "/resources/img/companies/workhere.png");
			u12.addRole(r3);
