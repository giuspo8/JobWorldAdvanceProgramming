...
             						<table>
										...
										<tr>
											<td><select name="minEducationLevel"
												class="searchsub_input searchsub_select">
						...
						</nav> </span> <span><a href="<c:url value="/"/>"><img
				...
				<c:choose>
					<c:when test="${isCompany}">
						...
						<li>-</li>
						<li><a href="<c:url value="/company/listjoboffer"/>">Offerte
								di lavoro</a></li>
						<li>-</li>
						<li><a href="<c:url value="/company/profile"/>"
