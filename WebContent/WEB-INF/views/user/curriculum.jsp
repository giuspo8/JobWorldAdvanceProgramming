	...
	<div class="body">
		<div class="container_slide">
			...
			<form:form id="curriculum_form" method="POST" action="${action_url}">
					...
					<textarea form='curriculum_form' name='workExperience'></textarea><br>
					<label class='searchsub_lbl'>Istruzione e Formazione</label><br>
					<textarea form='curriculum_form' name='education'></textarea><br>
					<label class='searchsub_lbl'>Competenze</label><br>
					<textarea form='curriculum_form' name='personalSkills'></textarea><br>
					<label class='searchsub_lbl'>Altre informazioni</label><br>
					<textarea form='curriculum_form' name='additionalInfo'></textarea>
					<div id='searchsub'>
