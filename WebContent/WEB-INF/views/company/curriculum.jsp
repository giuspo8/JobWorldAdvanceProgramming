...
<div class="offer">
	...
	<form:form id="curriculum_form" method="POST" action="${action_url}"
		...
		<h3>Ecco il curriculum di: ${person.getFirstName()}
			${person.getSecondName()}</h3> 
					<table style="text-align: center; width: 700px; margin: auto;">
			<tr>
				<td><label class='searchsub_lbl'>Esperienze lavorative</label><br></td>
			</tr>
			<tr>
				<td><textarea class="searchsub_input" form='curriculum_form'
						name='workExperience' disabled="disabled"
						style="height: 400px; resize: none; margin: auto;">${curriculum.workExperience }</textarea><br></td>
			</tr>
			<tr>
				<td><label class='searchsub_lbl'>Istruzione e
						Formazione</label><br></td>
			</tr>
			<tr>
				<td><textarea class="searchsub_input" form='curriculum_form'
						name='education' disabled="disabled"
						style="height: 400px; resize: none; margin: auto;">${curriculum.education }</textarea><br></td>
			</tr>
			<tr>
			...
			<tr>
				<td><textarea class="searchsub_input" form='curriculum_form'
						name='personalSkills' disabled="disabled"
						style="height: 400px; resize: none; margin: auto;">${curriculum.personalSkills }</textarea><br></td>
			</tr>
			<tr>
			...
			<tr>
				<td><textarea class="searchsub_input" form='curriculum_form'
						name='additionalInfo' disabled="disabled"
						style="height: 400px; resize: none; margin: auto;">${curriculum.additionalInfo }</textarea></td>
			</tr>
		</table>
